 ...
 */
public class ExxOrderStatus extends ExxBaseResponse {

  private final BTEROrderStatusInfo orderStatusInfo;

  private ExxOrderStatus(@JsonProperty("order") BTEROrderStatusInfo orderStatusInfo, @JsonProperty("result") boolean result,
  ...
  public static class BTEROrderStatusInfo {
    ...
    private BTEROrderStatusInfo(@JsonProperty("id") String id, @JsonProperty("status") String status, @JsonProperty("pair") String currencyPair,
        @JsonProperty("type") ExxOrderType type, @JsonProperty("rate") BigDecimal rate, @JsonProperty("amount") BigDecimal amount,
        @JsonProperty("initial_rate") BigDecimal initialRate, @JsonProperty("initial_amount") BigDecimal initialAmount) {

      this.id = id;
      this.status = status;
      this.currencyPair = ExxAdapters.adaptCurrencyPair(currencyPair);
      this.type = type;
      this.rate = rate;
      this.amount = amount;
