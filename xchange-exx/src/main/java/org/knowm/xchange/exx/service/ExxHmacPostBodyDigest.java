 ...
 */
public class ExxHmacPostBodyDigest extends BaseParamsDigest {
   ...
   */
  private ExxHmacPostBodyDigest(String secretKeyBase64) {

    super(secretKeyBase64, HMAC_SHA_512);
  }

  public static ExxHmacPostBodyDigest createInstance(String secretKeyBase64) {

    return secretKeyBase64 == null ? null : new ExxHmacPostBodyDigest(secretKeyBase64);
  }
